...
import re
#REMARQUE : Bonjour Monsieur, j'espère que vous allez bien. Dans l'énoncé de l'exercice,
# il y a eu beaucoup de confusions entre les collègues par rapport à ce qu'il fallait faire.
# De ce fait, ce programme accepte toutes les chaînes qui sont formée exclusivement d'une combinaison arbitraire de "at", "ta", "gc" ou "cg"
# Et pour la séquence, ce programme accepte toutes les chaînes qui sont formée exclusivement de "a", "t", "g" et/ou "c"
